...
import com.upc.bikefastgo.service.CardService;
...
@Tag(name = "CardController", description = "the card API")
@RestController
@RequestMapping("/api/bikefastgo/v1/cards")
public class CardController {
    ...
    // URL: http://localhost:8080/api/bikefastgo/v1/cards/{cardId}
    // Method: GET
    ...
    // URL: http://localhost:8080/api/bikefastgo/v1/cards/user/{userId}
    // Method: GET
    @Transactional(readOnly = true)
    ...
    // URL: http://localhost:8080/api/bikefastgo/v1/cards/{userId}
    // Method: POST
    @Transactional
    @PostMapping("/{userId}")
    ...
    // URL: http://localhost:8080/api/bikefastgo/v1/cards/{cardId}/main
    // Method: PATCH
    @Transactional
